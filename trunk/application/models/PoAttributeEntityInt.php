...
class Petolio_Model_PoAttributeEntityInt extends MainModel
{
...
function __construct() {
     ...
     *
     * @param int $data
     * @return Petolio_Model_PoAttributeEntityInt     
     *
     **/
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Petolio_Model_PoAttributeEntityIntMapper());
        }
        return $this->_mapper;
    }
