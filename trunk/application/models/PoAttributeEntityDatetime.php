...
class Petolio_Model_PoAttributeEntityDatetime extends MainModel
{
...
function __construct() {
     ...
     *
     * @param int $data
     * @return Petolio_Model_PoAttributeEntityDatetime     
     *
     **/
    ...
    /**
     * sets column value type datetime     
     *
     * @param datetime $data
     * @return Petolio_Model_PoAttributeEntityDatetime     
     *
    ...
    /**
     * gets column value type datetime
     * @return datetime     
     */
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Petolio_Model_PoAttributeEntityDatetimeMapper());
        }
        return $this->_mapper;
    }
