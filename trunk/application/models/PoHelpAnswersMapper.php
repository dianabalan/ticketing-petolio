...
class Petolio_Model_PoHelpAnswersMapper {
     ...
     * @param string $field
     * @param mixed $value
     * @param Petolio_Model_PoHelpAnswers $cls
     */
     ...
     *
     * @param new Petolio_Model_PoHelpAnswers $cls
     * @return array
     *
     */
    ...
    public function toObject($array) {
    	$cls = new Petolio_Model_PoHelpAnswers();

        return $cls->setId($array['id'])
			->setHelpId($array['help_id'])
			->setUserId($array['user_id'])
			->setAnswer($array['answer'])
    ...
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Petolio_Model_DbTable_PoHelpAnswers');
        }
    ...
    public function save(Petolio_Model_PoHelpAnswers $cls,$ignoreEmptyValuesOnUpdate=true, $escapeValues = false)
    {
       	$data = $cls->toArray();
    ...
    public function find($id, Petolio_Model_PoHelpAnswers $cls)
    {
    ...
    public function fetchAll()
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new Petolio_Model_PoHelpAnswers();
            $entry->setId($row->id)
				  ->setHelpId($row->help_id)
                  ->setUserId($row->user_id)
                  ->setAnswer($row->answer)
