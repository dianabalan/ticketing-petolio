<?php
/**
 * Validator which checks if the file is an image or pdf
 * Extends Zend_Validate_File_MimeType where the necessary isValid() method can be found 
 */
class Petolio_Validator_IsImageorPdf extends Zend_Validate_File_MimeType {
    /**
    ...
    protected $_messageTemplates = array(
        self::FALSE_TYPE   => "File '%value%' is no image or pdf, '%type%' detected",
