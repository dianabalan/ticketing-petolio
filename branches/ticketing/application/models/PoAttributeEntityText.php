...
class Petolio_Model_PoAttributeEntityText extends MainModel
{
...
function __construct() {
     ...
     *
     * @param int $data
     * @return Petolio_Model_PoAttributeEntityText     
     *
     **/
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Petolio_Model_PoAttributeEntityTextMapper());
        }
        return $this->_mapper;
    }
