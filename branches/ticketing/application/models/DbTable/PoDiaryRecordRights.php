...
class Petolio_Model_DbTable_PoDiaryRecordRights extends Zend_Db_Table_Abstract
{

    protected $_name = 'po_diary_record_rights';
    ...
    /**
     * returns a result set of users who have access to this diary record
     *
     * @param int $diary_record_id
     */
	public function findAllowedUsers($diary_record_id) {
    	$select = $this->select()->setIntegrityCheck(false)
	        	...
	        	->where($this->getAdapter()->quoteInto("a.diary_record_id = ?", $diary_record_id, Zend_Db::BIGINT_TYPE))
