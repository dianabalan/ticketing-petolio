...
class Petolio_Model_DbTable_PoMedicalRecordRights extends Zend_Db_Table_Abstract
{

    protected $_name = 'po_medical_record_rights';
    ...
    /**
     * returns a result set of users who have access to this medical record
     *
     * @param int $medical_record_id
     */
	public function findAllowedUsers($medical_record_id) {
    	$select = $this->select()->setIntegrityCheck(false)
	        	...
	        	->where($this->getAdapter()->quoteInto("a.medical_record_id = ?", $medical_record_id, Zend_Db::BIGINT_TYPE))
