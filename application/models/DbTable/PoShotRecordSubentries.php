...
class Petolio_Model_DbTable_PoShotRecordSubentries extends Zend_Db_Table_Abstract
{

    protected $_name = 'po_shot_record_subentries';
	...
	public function fetchList($where=null, $order=null, $count=null, $offset=null)
	{
		...
		if (!($where instanceof Zend_Db_Table_Select)) {
	    	$select = $this->select()->setIntegrityCheck(false)
					->from(array('a' => 'po_shot_record_subentries'))
					->joinLeft(
							array('b' => 'po_services'),
							'a.service_id = b.id',
							array(
	...
	/**
	 * fetch one subentry with the parent shot record attached to it
	 *
	 * @param int $id
	 */
	function findWithShotRecord($id) {
    	$select = $this->select()->setIntegrityCheck(false)
				->from(array('a' => 'po_shot_record_subentries'))
				->joinInner(
						array('b' => 'po_shot_records'),
						'a.shot_record_id = b.id',
						array(
							'mr_id' => 'id',
							'mr_pet_id' => 'pet_id',
							'mr_sickness' => 'sickness',
