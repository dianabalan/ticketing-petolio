...
class Petolio_Model_PoAttributeEntityVarchar extends MainModel
{
...
function __construct() {
     ...
     *
     * @param int $data
     * @return Petolio_Model_PoAttributeEntityVarchar     
     *
     **/
    ...
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new Petolio_Model_PoAttributeEntityVarcharMapper());
        }
        return $this->_mapper;
    }
