...
class Petolio_Validator_Date extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        ...
        self::MSG_FUTURE => "That date is in the future!",
